...
![Placeholder image for simple governance figure or flowchart.](../images/governance-structure-placeholder.svg){#fig-governance-structure fig-cap="Governance image to go here (placeholder graphic)." width="100%"}
...
- The program learns and adapts based on documented feedback and evaluation  
