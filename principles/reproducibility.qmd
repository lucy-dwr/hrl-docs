...
- HRL parties commit to stable data and metadata with unique identifiers, clearly scoped and documented datasets and analyses, documented and executable workflows with version control, and adherence to data use and sovereignty agreements.
- HRL parties use GitHub repositories with version control, captured environments, and CI/CD so workflows run the same every release.
...
The HRL program strives for reproducibility through these key expectations:

- **Define the purpose and scope** of data products and analyses so others understand what each dataset or analysis represents and answers.
- **Keep data, metadata, and documentation** in stable, accessible locations with persistent identifiers (e.g., DOIs).
- **Record every step from raw data to reported findings** in executable workflows with quality checks, decisions, assumptions, and environment and dependencies management.
- **Use automated tests and continuous integration/continuous deployment** to catch regressions early and keep workflows reproducible with every release.
- **Maintain version control** using common tools (e.g., git and GitHub) so that data products and results always trace back to the exact inputs, versions, and parameters used and important changes can be easily identified.
- **Honor data sharing agreements** by carrying forward access notes and restrictions for governed data.
- **Document workflows, checkpoints, and artifacts** so they can be audited and improved over the life of the program.
...
Detailed implementation standards, such as repository structures, naming conventions, dependency and environment management, testing, and automation, are provided in the HRL Style and Development Guide (link to be added when published). At a minimum:
...
- HRL Style and Development Guide – Source of detailed practices, code style, templates, and automation (link will be added here when the public guide is available).
