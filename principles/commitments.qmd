---
title: "HRL Science Program Commitments"
---
...
:::{.btn-container}
<a class="btn btn-outline-primary" role="button" href="../lifecycle/collection.qmd">HRL Data Lifecycle – Collection</a>
...
:::{.btn-container}
<a class="btn btn-outline-primary" role="button" href="../lifecycle/static-publication.qmd">Data Lifecycle – Static Publication</a>
<a class="btn btn-outline-primary" role="button" href="../standards/metadata.qmd">Standards – Metadata</a>
:::
...
:::{.btn-container}
<a class="btn btn-outline-primary" role="button" href="../lifecycle/storage-serving.qmd">Data Lifecycle – Storage and Serving</a>
<a class="btn btn-outline-primary" role="button" href="../reference/resources.qmd">Reference – Resources</a>
:::

### Integration and Analysis

- All analyses are implemented through **structured R or Python workflows** managed in HRL **GitHub repositories** that follow the [Style and Development Guide](../standards/style-dev-guide.qmd).
...
:::{.btn-container}
<a class="btn btn-outline-primary" role="button" href="../lifecycle/ingestion-standardization.qmd">Data Lifecycle – Ingestion and Standardization</a>
<a class="btn btn-outline-primary" role="button" href="../lifecycle/analysis-synthesis.qmd">Data Lifecycle – Analysis and Synthesis</a>
<a class="btn btn-outline-primary" role="button" href="../lifecycle/reporting-communication.qmd">Data Lifecycle – Reporting and Communication</a>
:::
