...
- LLM instructions (functionally a system prompt) can be found in [AGENTS.md](AGENTS.md).
...
- Understand the [lethal trifecta](https://simonwillison.net/2025/Jun/16/the-lethal-trifecta/) that can create critical LLM security vulnerabilities and ensure that your usage minimizes the potential for such risks.
